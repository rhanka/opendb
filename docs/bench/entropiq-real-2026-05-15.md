...
| Q7 | PASS | `select "id", "owner_user_id", "name", "type", "gate_config", "hidden_at", "created_at", "updated_at" from "workspaces" where "workspaces"."id" = $1` | rows=[{"id":"w1","ownerUserId":"u1","name":"Acme","type":"ai-ideas","gateConfig":null,"hiddenAt":null,"createdAt":"2026-05-01T00:00:00.000Z","updatedAt":"2026-05-15T00:49:53.578Z"} |
