...
| Q5 | FAIL | `select "folders"."id", "folders"."name", "folders"."status", count("initiatives"."id") from "folders" left join "initiatives" on ("initiatives"."folder_id" = "folders"."id" and "initiatives"."workspac` | error: sql error: unsupported literal: 'w1' group by "folders"."id", "folders"."name", "folders"."status" |
